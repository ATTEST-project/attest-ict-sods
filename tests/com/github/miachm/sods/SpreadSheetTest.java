...
public class SpreadSheetTest {
    ...
    private void readSpreadSheet(SpreadSheet spreadSheet) {
        System.out.println("Number of sheets: " + spreadSheet.getNumSheets());
    ...
    @Test
    public void testExponentialDouble() throws IOException {
        SpreadSheet spreadSheet = new SpreadSheet(new File("resources/scenario_gen.ods"));
        // readSpreadSheet(spreadSheet);
        Sheet probSheet = spreadSheet.getSheet(2);
        Range range = probSheet.getDataRange().getCell(1,1);
        assertEquals(1.5629045317604597E-8, range.getValue());
    }
}
